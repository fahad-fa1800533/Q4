...
from mlp_model_relu1 import MNIST_MLP_RELU1
from mlp_model_relu2 import MNIST_MLP_RELU2
from mlp_model_relu3 import MNIST_MLP_RELU3
...
def main():
    ...
    plt.plot(vah1, label='(784,20,10)')
    plt.plot(vah2, label='(784,20,20,10)')
    plt.plot(vah3, label='(784,50,30,20,10)')
    plt.legend()
    plt.ylabel('Accuracy')
    plt.xlabel('Epochs')
    plt.tight_layout()
